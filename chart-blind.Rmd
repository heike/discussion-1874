...
- Some things we didn't see before (unless looking very closely):
    + the proportion of foreigners is high for states that have been founded within the last two decades before the census was taken (such as WI 1848, ... IA 1846, )
    + there is a huge gender imbalance for blind individuals in Delaware   
